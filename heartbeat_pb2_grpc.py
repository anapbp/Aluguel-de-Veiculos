...
class HeartbeatServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.EnviarHeartbeat = channel.unary_unary(
                '/HeartbeatService/EnviarHeartbeat',
...
class HeartbeatServiceServicer(object):
    ...
    def EnviarHeartbeat(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_HeartbeatServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'EnviarHeartbeat': grpc.unary_unary_rpc_method_handler(
                    servicer.EnviarHeartbeat,
    ...
    server.add_registered_method_handlers('HeartbeatService', rpc_method_handlers)
