...
class InformationStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.TerminalOnLine = channel.unary_unary(
                '/Information/TerminalOnLine',
...
def add_InformationServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TerminalOnLine': grpc.unary_unary_rpc_method_handler(
                    servicer.TerminalOnLine,
